...
[CustomEditor(typeof(ADSMaterialsHelper))]
public class ADSMaterialsHelperInspector : Editor 
{
	private ADSMaterialsHelper targetScript;
	...
	void OnEnable()
    {
		...
		targetScript = (ADSMaterialsHelper)target;

        bannerText = "ADS Materials Helper";
