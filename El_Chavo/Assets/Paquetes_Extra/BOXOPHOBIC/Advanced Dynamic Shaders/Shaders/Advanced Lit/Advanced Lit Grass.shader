...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Advanced Lit/Grass"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 lerpResult293_g1586 = lerp( temp_output_92_0_g1586 , temp_output_160_0_g1586 , Motion_Turbulence1280);
			...
			half MotionMask137_g1586 = Packed_Grass1134;
			...
			half3 Motion_Grass1158 = appendResult232_g1586;
			float3 ase_vertex3Pos = v.vertex.xyz;
			half MotionFlutterScale60_g1584 = ( ADS_GlobalScale * _MotionScale3 );
			half MotionFlutterSpeed62_g1584 = ( ADS_GlobalSpeed * _MotionSpeed3 );
			float mulTime90_g1584 = _Time.y * MotionFlutterSpeed62_g1584;
			half MotionlFlutterAmplitude58_g1584 = ( ADS_GlobalAmplitude * _MotionAmplitude3 );
			half MotionMask137_g1584 = Packed_Grass1134;
			float3 ase_vertexNormal = v.normal.xyz;
			half3 Motion_Leaf1286 = ( ( ( sin( ( ( ase_vertex3Pos * MotionFlutterScale60_g1584 ) + mulTime90_g1584 ) ) * MotionlFlutterAmplitude58_g1584 ) * MotionMask137_g1584 ) * ase_vertexNormal );
			half3 Motion_Output1167 = ( ( Motion_Grass1158 + Motion_Leaf1286 ) * Motion_Turbulence1280 );
			half localunity_ObjectToWorld0w1_g1563 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld1w2_g1563 = ( unity_ObjectToWorld[1].w );
			half localunity_ObjectToWorld2w3_g1563 = ( unity_ObjectToWorld[2].w );
			float3 appendResult6_g1563 = (float3(localunity_ObjectToWorld0w1_g1563 , localunity_ObjectToWorld1w2_g1563 , localunity_ObjectToWorld2w3_g1563));
			float4 tex2DNode140_g1561 = tex2Dlod( ADS_GlobalTex, float4( ( ( (appendResult6_g1563).xz * (ADS_GlobalUVs).xy ) + (ADS_GlobalUVs).zw ), 0, 0.0) );
			half ADS_GlobalTex_B198_g1561 = tex2DNode140_g1561.b;
			float lerpResult156_g1561 = lerp( ADS_GlobalSizeMin , ADS_GlobalSizeMax , ADS_GlobalTex_B198_g1561);
			half3 Global_Size1245 = ( ( lerpResult156_g1561 * _GlobalSize ) * ase_vertex3Pos );
			v.vertex.xyz += ( Motion_Output1167 + Global_Size1245 );
			float4 temp_cast_2 = (1.0).xxxx;
			half4 ADS_GlobalTintColorOne176_g1561 = ADS_GlobalTintColorOne;
			half4 ADS_GlobalTintColorTwo177_g1561 = ADS_GlobalTintColorTwo;
			half ADS_GlobalTex_R180_g1561 = tex2DNode140_g1561.r;
			float4 lerpResult147_g1561 = lerp( ADS_GlobalTintColorOne176_g1561 , ADS_GlobalTintColorTwo177_g1561 , ADS_GlobalTex_R180_g1561);
			half ADS_GlobalTintIntensity181_g1561 = ADS_GlobalTintIntensity;
			half GlobalTint186_g1561 = _GlobalTint;
			float4 lerpResult150_g1561 = lerp( temp_cast_2 , ( lerpResult147_g1561 * ADS_GlobalTintIntensity181_g1561 ) , GlobalTint186_g1561);
			o.vertexToFrag1077 = lerpResult150_g1561;
		}
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float3 break17_g1571 = UnpackScaleNormal( tex2D( _NormalTex, uv_NormalTex607 ), _NormalScale );
			float switchResult12_g1571 = (((i.ASEVFace>0)?(break17_g1571.z):(-break17_g1571.z)));
			float3 appendResult18_g1571 = (float3(break17_g1571.x , break17_g1571.y , switchResult12_g1571));
			half3 Main_NormalTex620 = appendResult18_g1571;
...
Node;AmplifyShaderEditor.FunctionNode;1293;128,-256;Float;False;ADS Motion Custom;34;;1586;157ee7880d81d9e4ab5582c2b22b9a68;8,225,1,278,1,228,1,292,2,254,0,262,0,252,0,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1285;1152,-256;Float;False;ADS Motion Flutter;-1;;1584;87d8028e5f83178498a65cfa9f0e9ace;0;4;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;136;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1278;-1280,640;Float;False;ADS Global Settings;18;;1561;0fe83146627632b4981f5a0aa1b63801;0;1;171;FLOAT;0;False;3;COLOR;85;COLOR;165;FLOAT;157
...
Node;AmplifyShaderEditor.FunctionNode;1064;576,-896;Float;False;Normal BackFace;-1;;1571;121446c878db06f4c847f9c5afed7cfe;0;1;13;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1199;-640,-2688;Float;False;Internal Unity Props;44;;1572;b286e6ef621b64a4fb35da1e13fa143f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2D779CCB78AB8426024605F5339996CE8437FFC1