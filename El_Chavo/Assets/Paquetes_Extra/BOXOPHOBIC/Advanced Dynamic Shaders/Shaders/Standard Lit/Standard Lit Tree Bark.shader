...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Standard Lit/Tree Bark"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half MotionScale60_g1991 = ( ADS_GlobalScale * _MotionScale );
			half MotionSpeed62_g1991 = ( ADS_GlobalSpeed * _MotionSpeed );
			float mulTime90_g1991 = _Time.y * MotionSpeed62_g1991;
			float3 temp_output_95_0_g1991 = ( ( ase_worldPos * MotionScale60_g1991 ) + mulTime90_g1991 );
			half MotionlAmplitude58_g1991 = ( ADS_GlobalAmplitude * _MotionAmplitude );
			float3 temp_output_92_0_g1991 = ( sin( temp_output_95_0_g1991 ) * MotionlAmplitude58_g1991 );
			float3 temp_output_256_0_g1991 = mul( unity_WorldToObject, float4( ADS_GlobalDirection , 0.0 ) ).xyz;
			half3 MotionDirection59_g1991 = temp_output_256_0_g1991;
			half Packed_Trunk21634 = ( v.color.r * v.color.r );
			half ADS_TreeLeavesAffectMotion168_g1987 = 0.1;
			half ADS_TreeLeavesAmount157_g1987 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g1988 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g1988 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g1987 = saturate( ( ADS_TreeLeavesAmount157_g1987 - ( frac( ( localunity_ObjectToWorld0w1_g1988 + localunity_ObjectToWorld2w3_g1988 ) ) * ADS_GlobalLeavesVar ) ) );
			half LeavesAmountSimple172_g1987 = temp_output_142_0_g1987;
			float lerpResult156_g1987 = lerp( ADS_TreeLeavesAffectMotion168_g1987 , 1.0 , LeavesAmountSimple172_g1987);
			half MotionMask137_g1991 = ( Packed_Trunk21634 * lerpResult156_g1987 );
			float3 temp_output_94_0_g1991 = ( ( temp_output_92_0_g1991 * MotionDirection59_g1991 ) * MotionMask137_g1991 );
			float3 break231_g1991 = temp_output_94_0_g1991;
			float3 appendResult232_g1991 = (float3(break231_g1991.x , 0.0 , break231_g1991.z));
			half3 Motion_Trunk1749 = appendResult232_g1991;
			half MotionScale60_g1992 = ( ADS_GlobalScale * _MotionScale2 );
			half MotionSpeed62_g1992 = ( ADS_GlobalSpeed * _MotionSpeed2 );
			float mulTime90_g1992 = _Time.y * MotionSpeed62_g1992;
			float3 temp_output_95_0_g1992 = ( ( ase_worldPos * MotionScale60_g1992 ) + mulTime90_g1992 );
			half Packed_Variation1675 = v.color.a;
			half MotionVariation269_g1992 = ( _MotionVariation2 * Packed_Variation1675 );
			half MotionlAmplitude58_g1992 = ( ADS_GlobalAmplitude * _MotionAmplitude2 );
			float3 temp_output_92_0_g1992 = ( sin( ( temp_output_95_0_g1992 + MotionVariation269_g1992 ) ) * MotionlAmplitude58_g1992 );
			float3 lerpResult280_g1992 = lerp( ADS_GlobalDirection , float3(0,1,0) , _MotionVertical2);
			float3 temp_output_256_0_g1992 = mul( unity_WorldToObject, float4( lerpResult280_g1992 , 0.0 ) ).xyz;
			half3 MotionDirection59_g1992 = temp_output_256_0_g1992;
			half Packed_Branch1862 = v.color.g;
			half ADS_TreeLeavesAffectMotion168_g1989 = 0.1;
			float temp_output_152_0_g1989 = Packed_Variation1675;
			half ADS_TreeLeavesAmount157_g1989 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g1990 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g1990 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g1989 = saturate( ( ADS_TreeLeavesAmount157_g1989 - ( frac( ( localunity_ObjectToWorld0w1_g1990 + localunity_ObjectToWorld2w3_g1990 ) ) * ADS_GlobalLeavesVar ) ) );
			float lerpResult175_g1989 = lerp( 0.0 , ceil( ( temp_output_152_0_g1989 - temp_output_142_0_g1989 ) ) , step( temp_output_152_0_g1989 , 3.0 ));
			half LeavesAmountWithVariation161_g1989 = ( 1.0 - lerpResult175_g1989 );
			float lerpResult166_g1989 = lerp( ADS_TreeLeavesAffectMotion168_g1989 , 1.0 , LeavesAmountWithVariation161_g1989);
			half MotionMask137_g1992 = ( Packed_Branch1862 * lerpResult166_g1989 );
			float3 temp_output_94_0_g1992 = ( ( temp_output_92_0_g1992 * MotionDirection59_g1992 ) * MotionMask137_g1992 );
			half3 Motion_Branch1750 = temp_output_94_0_g1992;
			half localunity_ObjectToWorld0w1_g1984 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld1w2_g1984 = ( unity_ObjectToWorld[1].w );
			half localunity_ObjectToWorld2w3_g1984 = ( unity_ObjectToWorld[2].w );
			float3 appendResult6_g1984 = (float3(localunity_ObjectToWorld0w1_g1984 , localunity_ObjectToWorld1w2_g1984 , localunity_ObjectToWorld2w3_g1984));
			float2 panner73_g1982 = ( _Time.y * ( ADS_TurbulenceSpeed * (-ADS_GlobalDirection).xz ) + ( (appendResult6_g1984).xz * ADS_TurbulenceScale ));
			float lerpResult136_g1982 = lerp( 1.0 , saturate( pow( abs( tex2Dlod( ADS_TurbulenceTex, float4( panner73_g1982, 0, 0.0) ).r ) , ADS_TurbulenceContrast ) ) , _GlobalTurbulence);
			float ifLocalVar94_g1982 = 0;
			UNITY_BRANCH 
			if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) > 0.0001 )
				ifLocalVar94_g1982 = lerpResult136_g1982;
			else if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) < 0.0001 )
				ifLocalVar94_g1982 = 1.0;
			half Motion_Turbulence2199 = ifLocalVar94_g1982;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_7_0_g1872 = 0.0;
			...
			float temp_output_84_0_g1959 = ( ( Packed_Trunk1813 - temp_output_7_0_g1872 ) / ( ( _BaseBlendAmount * lerpResult2138 ) - temp_output_7_0_g1872 ) );
...
/*ASEBEGIN
Version=16209
1927;29;1906;1014;401.3463;-1596.722;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1425;1408,-256;Float;False;Remap To 0-1;-1;;1872;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1792;-384,1472;Half;False;Property;_Occlusion;Trunk Occlusion (G);18;0;Create;False;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2115;-384,1152;Float;False;const;-1;;1873;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2116;512,1152;Float;False;const;-1;;1871;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2146;1280,2432;Float;False;ADS Leaves Amount;-1;;1989;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.FunctionNode;2145;0,2432;Float;False;ADS Leaves Amount;-1;;1987;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.FunctionNode;2198;-1280,2496;Float;False;ADS Global Turbulence;14;;1982;047eb809542f42d40b4b5066e22cee72;0;0;1;FLOAT;85
...
Node;AmplifyShaderEditor.FunctionNode;2114;-1280,1152;Float;False;const;-1;;1993;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;2176;4224,512;Float;False;Property;_EnableBase;Enable Base;19;0;Create;True;0;0;False;0;0;0;0;False;;Toggle;2;Off;Base;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;2177;4224,-256;Float;False;Property;_EnableBase;Enable Base;22;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Off;Base;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;2173;4224,-64;Float;False;Property;_EnableBase;Enable Base;19;0;Create;True;0;0;False;0;0;0;0;False;;Toggle;2;Off;Base;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;2184;4224,128;Float;False;Property;_EnableBase;Enable Base;19;0;Create;True;0;0;False;0;0;0;0;False;;Toggle;2;Off;Base;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;2180;4224,320;Float;False;Property;_EnableBase;Enable Base;19;0;Create;True;0;0;False;0;0;0;0;False;;Toggle;2;Off;Base;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1938;0,-2688;Float;False;Internal Unity Props;69;;1995;b286e6ef621b64a4fb35da1e13fa143f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1469;-768,-3360;Half;False;Property;_SETTINGSS;[ SETTINGSS ];36;0;Create;True;0;0;True;1;BCategory(Settings);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2018;3264,1920;Float;False;ADS Motion Custom;59;;1994;157ee7880d81d9e4ab5582c2b22b9a68;8,225,0,278,1,228,1,292,1,254,0,262,0,252,3,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-128,-2176;Float;False;True;2;Float;ADSShaderGUI;300;0;Standard;BOXOPHOBIC/Advanced Dynamic Shaders/Standard Lit/Tree Bark;False;False;False;False;False;True;True;True;True;False;True;False;False;True;True;False;True;False;False;False;Back;0;False;925;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0;True;True;0;True;Opaque;;Geometry;All;True;True;True;False;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;True;550;10;True;553;0;1;False;550;10;False;553;0;True;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;300;Utils/ADS Fallback;-1;-1;-1;-1;0;False;0;0;False;743;-1;0;True;862;3;Include;../../../Utils/CGIncludes/VS_indirect.cginc;False;;Pragma;instancing_options procedural:setup;False;;Pragma;multi_compile GPU_FRUSTUM_ON __;False;;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=E12A3A6DFBFBF4FA18C6F578D8F297DE732208B3