...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Standard Lit/Tree Leaf"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half LeavesAmountSimple172_g1835 = temp_output_142_0_g1835;
			float lerpResult156_g1835 = lerp( ADS_TreeLeavesAffectMotion168_g1835 , 1.0 , LeavesAmountSimple172_g1835);
			half MotionMask137_g1839 = ( Packed_Trunk21809 * lerpResult156_g1835 );
			...
			half MotionScale60_g1840 = ( ADS_GlobalScale * _MotionScale2 );
			half MotionSpeed62_g1840 = ( ADS_GlobalSpeed * _MotionSpeed2 );
			float mulTime90_g1840 = _Time.y * MotionSpeed62_g1840;
			float3 temp_output_95_0_g1840 = ( ( ase_worldPos * MotionScale60_g1840 ) + mulTime90_g1840 );
			half Packed_Variation1815 = v.color.a;
			half MotionVariation269_g1840 = ( _MotionVariation2 * Packed_Variation1815 );
			half MotionlAmplitude58_g1840 = ( ADS_GlobalAmplitude * _MotionAmplitude2 );
			float3 temp_output_92_0_g1840 = ( sin( ( temp_output_95_0_g1840 + MotionVariation269_g1840 ) ) * MotionlAmplitude58_g1840 );
			float3 lerpResult280_g1840 = lerp( ADS_GlobalDirection , float3(0,1,0) , _MotionVertical2);
			float3 temp_output_256_0_g1840 = mul( unity_WorldToObject, float4( lerpResult280_g1840 , 0.0 ) ).xyz;
			half3 MotionDirection59_g1840 = temp_output_256_0_g1840;
			half Packed_Branch1830 = v.color.g;
			half ADS_TreeLeavesAffectMotion168_g1837 = 0.1;
			float temp_output_152_0_g1837 = Packed_Variation1815;
			half ADS_TreeLeavesAmount157_g1837 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g1838 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g1838 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g1837 = saturate( ( ADS_TreeLeavesAmount157_g1837 - ( frac( ( localunity_ObjectToWorld0w1_g1838 + localunity_ObjectToWorld2w3_g1838 ) ) * ADS_GlobalLeavesVar ) ) );
			float lerpResult175_g1837 = lerp( 0.0 , ceil( ( temp_output_152_0_g1837 - temp_output_142_0_g1837 ) ) , step( temp_output_152_0_g1837 , 3.0 ));
			half LeavesAmountWithVariation161_g1837 = ( 1.0 - lerpResult175_g1837 );
			float lerpResult166_g1837 = lerp( ADS_TreeLeavesAffectMotion168_g1837 , 1.0 , LeavesAmountWithVariation161_g1837);
			half MotionMask137_g1840 = ( Packed_Branch1830 * lerpResult166_g1837 );
			float3 temp_output_94_0_g1840 = ( ( temp_output_92_0_g1840 * MotionDirection59_g1840 ) * MotionMask137_g1840 );
			half3 Motion_Branch1750 = temp_output_94_0_g1840;
			float3 ase_vertex3Pos = v.vertex.xyz;
			half MotionFlutterScale60_g1841 = ( ADS_GlobalScale * _MotionScale3 );
			half MotionFlutterSpeed62_g1841 = ( ADS_GlobalSpeed * _MotionSpeed3 );
			float mulTime90_g1841 = _Time.y * MotionFlutterSpeed62_g1841;
			half MotionlFlutterAmplitude58_g1841 = ( ADS_GlobalAmplitude * _MotionAmplitude3 );
			half Packed_Leaf1819 = v.color.b;
			half MotionMask137_g1841 = Packed_Leaf1819;
			float3 ase_vertexNormal = v.normal.xyz;
			half3 Motion_Leaf1751 = ( ( ( sin( ( ( ase_vertex3Pos * MotionFlutterScale60_g1841 ) + mulTime90_g1841 ) ) * MotionlFlutterAmplitude58_g1841 ) * MotionMask137_g1841 ) * ase_vertexNormal );
			half localunity_ObjectToWorld0w1_g1832 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld1w2_g1832 = ( unity_ObjectToWorld[1].w );
			half localunity_ObjectToWorld2w3_g1832 = ( unity_ObjectToWorld[2].w );
			float3 appendResult6_g1832 = (float3(localunity_ObjectToWorld0w1_g1832 , localunity_ObjectToWorld1w2_g1832 , localunity_ObjectToWorld2w3_g1832));
			float2 panner73_g1830 = ( _Time.y * ( ADS_TurbulenceSpeed * (-ADS_GlobalDirection).xz ) + ( (appendResult6_g1832).xz * ADS_TurbulenceScale ));
			float lerpResult136_g1830 = lerp( 1.0 , saturate( pow( abs( tex2Dlod( ADS_TurbulenceTex, float4( panner73_g1830, 0, 0.0) ).r ) , ADS_TurbulenceContrast ) ) , _GlobalTurbulence);
			float ifLocalVar94_g1830 = 0;
			UNITY_BRANCH 
			if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) > 0.0001 )
				ifLocalVar94_g1830 = lerpResult136_g1830;
			else if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) < 0.0001 )
				ifLocalVar94_g1830 = 1.0;
			half Motion_Turbulence1921 = ifLocalVar94_g1830;
			...
			half4 ADS_GlobalTintColorOne176_g1842 = ADS_GlobalTintColorOne;
			half4 ADS_GlobalTintColorTwo177_g1842 = ADS_GlobalTintColorTwo;
			half localunity_ObjectToWorld0w1_g1846 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g1846 = ( unity_ObjectToWorld[2].w );
			float lerpResult194_g1842 = lerp( frac( ( localunity_ObjectToWorld0w1_g1846 + localunity_ObjectToWorld2w3_g1846 ) ) , Packed_Variation1815 , _DetailTint);
			float4 lerpResult166_g1842 = lerp( ADS_GlobalTintColorOne176_g1842 , ADS_GlobalTintColorTwo177_g1842 , lerpResult194_g1842);
			half ADS_GlobalTintIntensity181_g1842 = ADS_GlobalTintIntensity;
			half GlobalTint186_g1842 = _GlobalTint;
			float4 lerpResult168_g1842 = lerp( temp_cast_4 , ( lerpResult166_g1842 * ADS_GlobalTintIntensity181_g1842 ) , GlobalTint186_g1842);
			o.vertexToFrag1907 = lerpResult168_g1842;
		}

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float2 uv_NormalTex607 = i.uv_texcoord;
			float3 temp_output_13_0_g1851 = UnpackScaleNormal( tex2D( _NormalTex, uv_NormalTex607 ), _NormalScale );
			float3 break17_g1851 = temp_output_13_0_g1851;
			float switchResult12_g1851 = (((i.ASEVFace>0)?(break17_g1851.z):(-break17_g1851.z)));
			float3 appendResult18_g1851 = (float3(break17_g1851.x , break17_g1851.y , switchResult12_g1851));
			float3 lerpResult20_g1851 = lerp( temp_output_13_0_g1851 , appendResult18_g1851 , _NormalInvertOnBackface);
			half3 Main_NormalTex620 = lerpResult20_g1851;
			...
			float temp_output_152_0_g1847 = Packed_Variation1815;
			half ADS_TreeLeavesAmount157_g1847 = ADS_GlobalLeavesAmount;
			...
			float temp_output_142_0_g1847 = saturate( ( ADS_TreeLeavesAmount157_g1847 - ( frac( ( localunity_ObjectToWorld0w1_g1848 + localunity_ObjectToWorld2w3_g1848 ) ) * ADS_GlobalLeavesVar ) ) );
			float lerpResult175_g1847 = lerp( 0.0 , ceil( ( temp_output_152_0_g1847 - temp_output_142_0_g1847 ) ) , step( temp_output_152_0_g1847 , 3.0 ));
			half Opacity1306 = saturate( ( Main_AlbedoTex_A616 - lerpResult175_g1847 ) );
...
/*ASEBEGIN
Version=16209
1927;29;1906;1014;1037.079;-584.3454;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1893;896,1280;Float;False;ADS Leaves Amount;-1;;1837;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.FunctionNode;1891;-384,1280;Float;False;ADS Leaves Amount;-1;;1835;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.FunctionNode;1919;2560,768;Float;False;ADS Motion Flutter;-1;;1841;87d8028e5f83178498a65cfa9f0e9ace;0;4;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;136;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1857;1536,768;Float;False;ADS Motion Custom;29;;1840;157ee7880d81d9e4ab5582c2b22b9a68;8,225,0,278,1,228,1,292,1,254,0,262,0,252,3,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1920;-1280,1344;Float;False;ADS Global Turbulence;15;;1830;047eb809542f42d40b4b5066e22cee72;0;0;1;FLOAT;85
...
Node;AmplifyShaderEditor.FunctionNode;1906;-1024,1920;Float;False;ADS Global Settings;22;;1842;0fe83146627632b4981f5a0aa1b63801;0;1;171;FLOAT;0;False;3;COLOR;85;COLOR;165;FLOAT;157
Node;AmplifyShaderEditor.FunctionNode;1884;-1008,0;Float;False;ADS Leaves Amount;-1;;1847;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
Node;AmplifyShaderEditor.FunctionNode;1902;895.382,-127.3066;Float;False;const;-1;;1849;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1901;0,-128;Float;False;const;-1;;1850;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1915;976,-896;Float;False;ADS Normal Backface;-1;;1851;4f53bc25e6d8da34db70401bcf363a2a;0;2;13;FLOAT3;0,0,0;False;30;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1846;0,-2560;Float;False;Internal Unity Props;57;;1852;b286e6ef621b64a4fb35da1e13fa143f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B26A9B17473138CFFF4579ED9A0780A14E90E20B